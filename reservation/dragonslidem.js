...
function slideShow() {
  ...
  var globals = {
    ...
    wrapperID: "dragonSlidem", // The ID of the <div> element that contains all of the <img> elements to be shown as a slide show.
  ...
  function initializeSlideShowMarkup() {  
    var slideWidthMax = 500; // Returns a value that is always in pixel units.
    var slideHeightMax = 500; // Returns a value that is always in pixel units.
